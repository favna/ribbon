...
export default class RibbonStatsCommand extends Command {
    ...
    public async run (msg: CommandoMessage): Promise<any> {
        ...
        statsEmbed
            ...
            .addField('Uptime', moment.duration(this.client.uptime)
                .format('DD [days], HH [hours and] mm [minutes]'), true)
            ...
            .setFooter(`Ribbon | ${moment()
                .format('MMMM Do YYYY [at] HH:mm:ss [UTC]Z')}`, 'https://favna.xyz/images/appIcons/ribbon.png');
