...
export default class DeleteWarnCommand extends Command {
        ...
        super(client, {
            ...
            args: [
                ...
                },
                {
                    key: 'points',
                    prompt:
                        'How many warning points should I remove from this member?',
                    type: 'integer',
                    default: 999999,
                },
            ],
    ...
    public run(
        msg: CommandoMessage,
        { member, points }: { member: GuildMember; points: number }
    ) {
        ...
        try {
            ...
            if (/(?:no such table)/i.test(err.toString())) {
                ...
                return msg.reply(
                    'there were no warnings for that user yet, I created an entry and assigned 0 points'
                );
            }
            ...
            channel.send(stripIndents`
                ...
                }> Error occurred in \`deletewarn\` command!
