...
export default class NewsCommand extends Command {
  ...
  public async run(msg: CommandoMessage, { body }: NewsArgs) {
    try {
      let announce = body;
      ...
      if (msg.guild.settings.get('announcechannel')) {
        newsChannel = msg.guild.channels.find(c => c.id === msg.guild.settings.get('announcechannel')) as TextChannel;
      } else {
        newsChannel = msg.guild.channels.find(c => c.name === 'announcements' || c.name === 'news') as TextChannel;
      }
      ...
      if (msg.guild.settings.get('modlogs', true)) {
        logModMessage(
          msg, msg.guild, modlogChannel, msg.guild.channels.get(modlogChannel) as TextChannel, announceEmbed
        );
      }
