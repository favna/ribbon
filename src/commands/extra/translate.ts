...
export default class TranslateCommand extends Command {
    constructor(client: CommandoClient) {
        super(client, {
            ...
            description:
                'Translate any word from any language to any other language',
    ...
    public async run(
        ...
        try {
            ...
            transEmbed
                ...
                .setTitle(
                    `__Translating from ${fromlang.toUpperCase()} to ${tolang.toUpperCase()}__`
            ...
            channel.send(stripIndents`
                ...
                }> Error occurred in \`translate\` command!
