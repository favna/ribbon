...
export default class BadWordsCommand extends Command {
  ...
  @resolveGuildI18n()
  public async run(msg: CommandoMessage, { shouldEnable, words, language }: BadWordsArgs) {
    ...
    if (msg.guild.settings.get('modlogs', true)) {
      logModMessage(
        msg, msg.guild, modlogChannel, msg.guild.channels.get(modlogChannel) as TextChannel, bwfEmbed
      );
    }
