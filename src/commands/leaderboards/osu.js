  ...
  async run (msg, args) {
    try {
      ...
      osuEmbed
        ...
        .setImage(`http://lemmmy.pw/osusig/sig.php?colour=hex2255EE&uname=${osuData.body[0].username}&flagshadow&darktriangles&avatarrounding=4&onlineindicator=undefined&xpbar&xpbarhex`)
