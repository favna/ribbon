...
export const arrayClean = (deleteValue, array) => {
...
export const countCaps = (capcount, total) => (capcount.replace(/[^A-Z]/g, '').length / total.length) * 100;
...
export const countMentions = (str) => {
...
export const deleteCommandMessages = (msg, client) => { // eslint-disable-line consistent-return
  if (msg.deletable && client.provider.get(msg.guild, 'deletecommandmessages', false)) {
    return msg.delete();
  }
};

export const numberBetween = (num, lower, upper, inclusive) => {
...
export const stopTyping = (msg) => {
  msg.channel.stopTyping(true);
};

export const startTyping = (msg) => {
