    ...
    try {
        if (guild.settings.get('memberlogs', true)) {
            const memberLogs = guild.settings.get('memberlogchannel',
                joinMember.guild.channels.find((c: TextChannel) => c.name === 'member-logs') ? joinMember.guild.channels.find((c: TextChannel) => c.name === 'member-logs').id : null);
...
export const handleMemberLeave = (client: CommandoClient, leaveMember: GuildMember): any => {
    ...
    try {
        if (guild.settings.get('memberlogs', true)) {
            ...
            const memberLogs = guild.settings.get('memberlogchannel',
                leaveMember.guild.channels.find((c: TextChannel) => c.name === 'member-logs') ? leaveMember.guild.channels.find((c: TextChannel) => c.name === 'member-logs').id : null);
