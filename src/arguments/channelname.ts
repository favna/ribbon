...
const resolveChannel = (query: GuildChannel | KlasaMessage | string, guild: KlasaGuild): GuildChannel => {
...
export default class ChannelnameArgument extends Argument {
  run(arg: Parameters<typeof resolveChannel>[0], possible: Possible, msg: KlasaMessage) {
