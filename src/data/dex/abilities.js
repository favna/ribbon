...
const BattleAbilities = [{
	...
	},
	{
		...
		onAllyTryAddVolatile: function (status, target, effect) {
	...
	},
	{
		...
		onBasePowerPriority: 8,
		onAllyBasePower: function (attacker, move) {
	...
	},
	{
		...
		onModifyAtk: function (attacker, move) {
		...
		onModifySpA: function (attacker, move) {
			if (move.type === 'Fire' && attacker.hp <= attacker.maxhp / 3) {
				this.debug('Blaze boost');
				return this.chainModify(1.5);
			}
	...
	},
	{
		...
		onAfterMoveSecondary: function (target, move) {
			if (!target.hp) return;
			let type = move.type;
	...
	},
	{
		...
		onSetStatus: function (target, effect) {
	...
	},
	{
		...
		onAfterDamage: function (source, move) {
	...
	},
	{
		...
		id: "damp",
		onAnyTryMove: function (target, effect) {
	...
	},
	{
		...
		onAnyBasePower: function (source, target, move) {
	...
	},
	{
		...
		onAnySetWeather: function (weather) {
	...
	},
	{
		...
		onDamagePriority: 1,
		onDamage: function (target, effect) {
	...
	},
	{
		...
		onWeather: function (target, effect) {
	...
	},
	{
		...
		onAfterDamage: function (damage, target, effect) {
	...
	},
	{
		...
		onSourceModifyDamage: function (move) {
			if (move.typeMod > 0) {
	...
	},
	{
		...
		onBasePowerPriority: 8,
		onBasePower: function (attacker, move) {
	...
	},
	{
		...
		onAllySetStatus: function (target, effect) {
	...
	},
	{
		...
		id: "friendguard",
		name: "Friend Guard",
		onAnyModifyDamage: function (target) {
	...
	},
	{
		...
		onModifyPriority: function (priority, pokemon, move) {
	...
	},
	{
		...
		onAfterDamage: function (target, source, effect) {
	...
	},
	{
		...
		onBasePowerPriority: 7,
		onSourceBasePower: function (move) {
			if (move.type === 'Fire') {
				return this.chainModify(0.5);
			}
		},
		onDamage: function (damage, effect) {
	...
	},
	{
		...
		onSetStatus: function (status, target, effect) {
	...
	},
	{
		...
		onModifyCritRatio: function (target) {
	...
	},
	{
		...
		onSourceModifySecondaries: function (secondaries, move) {
			// @ts-ignore
	...
	},
	{
		...
		onPrepareHit: function (source, move) {
	...
	},
	{
		...
		onAllyTryHitSide: function (move) {
			if (move.flags['sound']) {
	...
	},
	{
		...
		onBeforeMove: function (attacker, move) {
	...
	},
	{
		...
		onTakeItem: function (pokemon, source) {
	...
	},
	{
		...
		onSourceModifyAtk: function (move) {
		...
		onModifySpAPriority: 5,
		onSourceModifySpA: function (move) {
			if (move.type === 'Ice' || move.type === 'Fire') {
				this.debug('Thick Fat weaken');
				return this.chainModify(0.5);
			}
	...
	},
	{
		...
		onAfterUseItem: function (pokemon) {
	...
	},
	{
		...
		onAfterDamage: function (target, move) {
	...
	},
	{
		...
		onModifyAccuracy: function (move) {
