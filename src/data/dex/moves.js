...
const BattleMovedex = [{
	...
	},
	{
		...
		accuracy: 100,
		basePower: 55,
		basePowerCallback: function (pokemon, move) {
			if (!pokemon.item) {
	...
	},
	{
		...
		effect: {
			duration: 1,
			onFoeAfterDamage: function (target) {
	...
	},
	{
		...
		effect: {
			...
			onAnyModifyDamage: function (source, target, move) {
	...
	},
	{
		...
		effect: {
			...
			onDamage: function (damage, source, move) {
	...
	},
	{
		...
		effect: {
			...
			onRedirectTarget: function (source) {
	...
	},
	{
		...
		accuracy: 100,
		basePower: 0,
		basePowerCallback: function (target) {
	...
	},
	{
		...
		effect: {
			...
			onOverrideAction: function (move) {
	...
	},
	{
		...
		effect: {
			...
			onFoeRedirectTarget: function (source, move) {
	...
	},
	{
		...
		effect: {
			...
			onFaint: function (source, effect) {
	...
	},
	{
		...
		effect: {
			...
			onTryHeal: function (damage, effect) {
	...
	},
	{
		...
		effect: {
			...
			onFoeBeforeMove: function (attacker, move) {
	...
	},
	{
		...
		onBasePowerPriority: 4,
		onBasePower: function (source, target, move) {
			let item = target.getItem();
	...
	},
	{
		...
		effect: {
			noCopy: true, // doesn't get copied by Baton Pass
			duration: 2,
			onSourceAccuracy: function (target, source, move) {
	...
	},
	{
		...
		onUseMoveMessage: function (pokemon, move) {
			// @ts-ignore
	...
	},
	{
		...
		effect: {
			...
			onTryAddVolatile: function (status, target, effect) {
				if (!target.isGrounded() || target.isSemiInvulnerable()) return;
			...
			onBasePower: function (defender, move) {
	...
	},
	{
		...
		onPrepareHit: function (pokemon, move) {
	...
	},
	{
		...
		onHitField: function (source, move) {
			let result = false;
			let message = false;
			for (const side of this.sides) {
				for (const pokemon of side.active) {
	...
	},
	{
		...
		effect: {
			...
			onSetStatus: function (target, source, effect) {
	...
	},
	{
		...
		effect: {
			...
			onFoeBeforeMove: function (attacker) {
	...
	},
	{
		...
		effect: {
			...
			onAnyTryMove: function (source, move) {
	...
	},
	{
		...
		accuracy: true,
		basePower: 0,
		basePowerCallback: function (source, move) {
