...
<p>Shuffles using a <a href="https://en.wikipedia.org/wiki/Fisher%E2%80%93Yates_shuffle#The_modern_algorithm">modern version of the Fisher-Yates shuffle
    algorithm</a></p>
...
| Param | Type | Description |
| --- | --- | --- |
| [CommandName || All] | <code>string</code> | Command name to get info for, nothing for the default or all to get all commands |
...
| Param | Type | Description |
| --- | --- | --- |
| Language | <code>en</code> \| <code>nl</code> | The new language to set |
...
| Param | Type | Description |
| --- | --- | --- |
| ImageURL | <code>string</code> | Image to get the source for |
